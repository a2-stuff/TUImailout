...
import { isMailchimpConfigured } from '../utils/config.js';
...
const SendMailchimp: React.FC<Props> = ({ setView, theme }) => {
        ...
        return (
            <Box flexDirection="column" padding={2}>
                ...
                <Box borderStyle="round" borderColor="red" padding={1} flexDirection="column">
                    ...
                    <Box marginTop={1}>
                        <Text>Please go to Settings and enter your Mailchimp API Key.</Text>
                    </Box>
                </Box>
                <Box marginTop={1}>
                    <SelectInput
    ...
    const sendEmail = async () => {
        ...
        try {
            await sendMailchimpEmail(from, recipients, subject, body);
    ...
    return (
        <Box flexDirection="column" padding={2}>
            <Header theme={theme} title="Send via Mailchimp" />
